...
function inc() {
    ...
    if (letter_count >= word.length) {
        ...
        setTimeout(inc, 200); // Decreased timeout value
    }
}
...
function updateTime() {
    ...
    var milliseconds = now.getMilliseconds().toString().padStart(3, '0').slice(0, 2);

    var timeString = week_day + " " + months + " " + days + " | " + hours + ":" + minutes + ":" + seconds + ":" + milliseconds;
